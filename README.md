...
Test_Results folder(Block_0_Postman.png)
3. Make your first request of ownership sending your wallet address:
    ![Request: http://localhost:8000/requestValidation ]
Test_Results folder(Postman Address to Message.png)
4. Sign the message with your Wallet:
    ![Use the Wallet to sign a message]
Test_Results folder(Electrum Sign Address-Message.png)
5. Submit your Star
     ![Request: http://localhost:8000/submitstar] 
Test_Results folder(submitStar_Postman.png)
6. Retrieve Stars owned by me
    ![Request: http://localhost:8000/blocks/1Arr8SAeApxxMYpssG3RtaXGFepBwuR7XT]Test_Results folder(getStar_Postman.png)